...
import 'package:ALMNEY/services/countryProvider.dart';
    ...
    if (res.statusCode == 200) {
      ...
      myCoursesModel.enrollDetails.forEach((element) {
        if (element.enroll.bundleId == null) {
          ...
          bundlePurchasedListIds.add(int.tryParse(element.enroll.bundleId));
          element.enroll.bundleCourseId.forEach((element) {
            bundlePurchasedListCoursesIds.add(int.tryParse(element));
          });
        }
      });
    } else {
