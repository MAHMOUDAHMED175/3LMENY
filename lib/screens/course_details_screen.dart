...
import 'package:ALMNEY/Screens/rate_course_screen.dart';
import 'package:ALMNEY/Widgets/videoplayer.dart';
import 'package:ALMNEY/common/global.dart';
import 'package:ALMNEY/model/purchase_history_model.dart';
import 'package:ALMNEY/provider/recent_course_provider.dart';
...
class _CourseDetailScreenState extends State<CourseDetailScreen>
  ...
  Future<void> loadData() async {
    ...
    getinstdetails = await getinstdata(apiData.userId) ?? detail;
    print("Data Loaded!");
    setState(() {});
  }
          ...
          return Container(
            ...
            child: CustomScrollView(
              slivers: [
                ...
                // if course is free
                if (!purchased && type == "0")
                  AddAndBuy(details.course.id, null, details),
                if (purchased)
