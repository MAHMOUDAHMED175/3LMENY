import 'dart:convert';
import 'dart:io';
import 'package:ALMNEY/Screens/gift_course_screen.dart';
import 'package:ALMNEY/model/course_with_progress.dart';
...
import 'package:ALMNEY/player/playlist_screen.dart';
    ...
    if (dripType == "date") {
      ...
      if (dripDays != null) {
        return widget.purchaseDate
                .add(Duration(days: int.tryParse(dripDays)))
