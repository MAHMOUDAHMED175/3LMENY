...
import 'package:ALMNEY/Screens/more_screen.dart';
import 'package:ALMNEY/Screens/pdf_viewer.dart';
import 'package:ALMNEY/player/custom_player.dart';
import 'package:ALMNEY/player/iframe_player.dart';
import 'package:ALMNEY/player/offline/offline_data.dart';
...
import 'package:ALMNEY/model/recieved_progress.dart';
import 'package:ALMNEY/model/zoom_meeting.dart';
import 'package:ALMNEY/player/clips.dart';
import 'package:ALMNEY/provider/courses_provider.dart';
import 'package:ALMNEY/provider/full_course_detail.dart';
import 'package:ALMNEY/provider/home_data_provider.dart';
import 'package:ALMNEY/zoom/join_screen.dart';
...
class _PlayListScreenState extends State<PlayListScreen>
  ...
  Future<RecievedProgress> updateProgress(List<String> checked) async {
    ...
    if (res.statusCode == 200) {
      print("Update Progress API Response :-> ${res.body}");
  ...
  Future<void> initClass() async {
    if (widget.defaultIndex == 0) {
      if (await storage.containsKey(
        ...
        newIndex = int.tryParse(await storage.read(
            key: 'courseId : ${widget.courseDetails.course.id}'));
      else
